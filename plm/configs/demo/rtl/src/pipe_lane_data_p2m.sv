...
module pipe_lane_data_p2m #(
    ...
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_4 (
        .sel  (sel_tgt.g1),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[4]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[4])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_5 (
        .sel  (sel_tgt.g1),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[5]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[5])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_6 (
        .sel  (sel_tgt.g1),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[6]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[6])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_7 (
        .sel  (sel_tgt.g1),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[7]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[7])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_8 (
        .sel  (sel_tgt.g2),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[8]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[8])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_9 (
        .sel  (sel_tgt.g2),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[9]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[9])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_10 (
        .sel  (sel_tgt.g2),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[10]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[10])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl0_11 (
        .sel  (sel_tgt.g2),
        .din  ({ctrl0_safe_p2m_align, phy_phy2mac[11]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[11])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(3)) u_p2m_ctrl0_12 (
        .sel  (sel_tgt.g3),
        .din  ({ctrl0_safe_p2m_align, ctrl0_safe_p2m_align, phy_phy2mac[12]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[12])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(3)) u_p2m_ctrl0_13 (
        .sel  (sel_tgt.g3),
        .din  ({ctrl0_safe_p2m_align, ctrl0_safe_p2m_align, phy_phy2mac[13]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[13])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(3)) u_p2m_ctrl0_14 (
        .sel  (sel_tgt.g3),
        .din  ({ctrl0_safe_p2m_align, ctrl0_safe_p2m_align, phy_phy2mac[14]}),
        .safe (ctrl0_safe_p2m_align),
        .dout (ctrl0_phy2mac[14])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(3)) u_p2m_ctrl0_15 (
        .sel  (sel_tgt.g3),
    ...
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl1_0 (
        .sel  (sel_tgt.g1),
        .din  ({phy_phy2mac[4], ctrl1_safe_p2m_align}),
        .safe (ctrl1_safe_p2m_align),
        .dout (ctrl1_phy2mac[0])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl1_1 (
        .sel  (sel_tgt.g1),
        .din  ({phy_phy2mac[5], ctrl1_safe_p2m_align}),
        .safe (ctrl1_safe_p2m_align),
        .dout (ctrl1_phy2mac[1])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl1_2 (
        .sel  (sel_tgt.g1),
        .din  ({phy_phy2mac[6], ctrl1_safe_p2m_align}),
        .safe (ctrl1_safe_p2m_align),
        .dout (ctrl1_phy2mac[2])
    );
    pipe_lane_data_mux #(.WIDTH($bits(phy2mac_lane_t)), .N(2)) u_p2m_ctrl1_3 (
        .sel  (sel_tgt.g1),
