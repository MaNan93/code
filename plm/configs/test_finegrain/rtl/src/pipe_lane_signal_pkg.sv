package pipe_lane_signal_pkg;
    ...
    // G2 (lane2~2): bit0=CtrlAlpha, bit1=CtrlEpsilon
    // G3 (lane3~3): direct to CtrlBeta, no sel
    // G4 (lane4~4): bit0=CtrlBeta, bit1=CtrlZeta
    // G5 (lane5~5): direct to CtrlGamma, no sel
    typedef struct packed {
        logic [1:0] g1;
        logic [1:0] g2;
        logic [1:0] g4;
